...
class getMailer_TransportFactory_GmailService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return new \Symfony\Component\Mailer\Bridge\Google\Transport\GmailTransportFactory(($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container)), NULL, ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
}
